...
public class RandomString {
	...
	public static final String CHARACTOR = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
	...
	public static String generateRandomEmail(String lastEmailString) {
		return generateRandomString(NUMBER_EMAIL) + "@" + lastEmailString;
	}
